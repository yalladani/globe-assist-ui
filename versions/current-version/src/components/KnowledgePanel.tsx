      ...
      <div className="h-full flex flex-col">
        <Tabs defaultValue="knowledge" className="flex-1 flex flex-col">
          ...
          <TabsContent value="knowledge" className="flex-1 p-6 pt-4">
            {response ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">No knowledge response available.</p>
                <p className="text-sm text-gray-400 mt-2">
                  Submit a question to get a response from the knowledge base.
                </p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="atlassian" className="flex-1 p-6 pt-4 overflow-y-auto">
            <AtlassianResults query={searchQuery} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
