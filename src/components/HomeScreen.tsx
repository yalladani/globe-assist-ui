      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-2xl">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-globe-text-secondary mb-4">Try asking about:</p>
            <div className="flex flex-wrap justify-center gap-2">
              {[
                ...
                <button
                  key={example}
                  className="text-xs bg-globe-accent-light text-primary px-3 py-1 rounded-full hover:bg-primary/10 transition-colors"
                  onClick={() => {
                    // You could auto-fill the prompt here
                  }}
                >
                  {example}
                </button>
